# -*- coding: utf-8 -*-
"""
Created on Fri Aug 16 13:31:55 2019
...
y=employee.items() # dict.items() returns dict. items.
print(y)

z=employee.keys() #dict.keys() returns keys of dict.
print(z)

a=employee.values() # dict.values() returns values of dict.
print(a)

employee.update({'Rank':3}) # dict.update({k:v}) update dict. by adding key-value pair of dict. in argument to this dict.
print(employee)

x=employee.copy() #dict.copy() returns copy of dict.
print(x)

p=employee.popitem() #dict.popitem() removes last pair of dict. and returns the pair.
print('Removed',p)

p=employee.pop('salary') # dict.pop removes item associated to specified key.
print(employee)
p=employee.pop('salary',100) #returns default value if specified item associated to key is not present.
print(p)

employee.clear() #dict.clear() used to delete all items of dict.
print(employee)
