# -*- coding: utf-8 -*-
"""
Created on Fri Aug 16 13:23:18 2019

@author: jigyasa
"""

t=(101,'Rahul',202)
print(type(t))  # type() returns the type of variables
print(len(t))   # len() returns the length of varaible.
t1=(101,'Ankit',23)
...
print(len(t1)) # len(tuple) returns length of tuple.

print(max(t2)) #max(tuple) returns maximum element of tuple.
print(max(t5))

print(min(t2)) #min(tuple) returns minimum element of tuple.
print(min(t5))

print(tuple([2,5])) #tuple(seq) converts any sequence represented by seq into tuple.
print(tuple(l1))
